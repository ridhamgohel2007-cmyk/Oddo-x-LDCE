...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-10 pb-12">
      {/* Hero Banner Section */}
      <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-r from-[#0B1320] via-[#111E2E] to-[#0B1320] min-h-[360px] flex items-center border border-slate-200 dark:border-[#1E2D42]">
        <img
        ...
        <div className="relative z-10 p-8 sm:p-14 max-w-3xl text-white space-y-5">
          ...
          <div className="pt-2 flex flex-wrap gap-3">
            <Link
              to="/create-trip"
              className="px-6 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white rounded-2xl font-bold text-xs shadow-xl shadow-emerald-500/30 flex items-center space-x-2 transition hover:-translate-y-0.5"
            >
